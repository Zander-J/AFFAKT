...
import torchvision
from models.adapter import vit_adapter_conv
...
class ViT_model(nn.Module):
    ...
    def forward(self, data_collection, train_stage=None):
        x = data_collection.visual.to(self.device)
        ...
        return self.result(output=output, loss=loss, transport_plan=None)
