            ...
            if num_adapter == num_encoder:
                for i in range(num_encoder):
                    if adapter_type == "mlp":
                        ...
                        raise NotImplementedError(f"Such method has not beed implemented.")
...
class VideoMAE(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.videoMAEModel = VideoMAEForVideoClassification.from_pretrained(pretrained_model_visual)
