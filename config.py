...
def get_args(namespace=None):
    ...
    parser.add_argument(
        "--memory_sufficient",
        action="store_true",
        help="If there is sufficient memory to load videos ahead of training, which may save training time.",
    )
    ...
    parser.add_argument(
        ...
        default="RealLife",
        type=str,
        choices=["RealLife", "Interview", "DOLOS"],
    )
    parser.add_argument(
        "--num_frames",
        default=16,
    ...
    parser.add_argument(
        "--source_feature",
        default="source_domain/dfew_features.hdf5",
        type=str,
