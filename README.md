...
PyTorch implementation of AAAI 2025 paper "AFFAKT: A Hierarchical Optimal Transport Based Method for Affective Facial Knowledge Transfer in Video Deception Detection".

![affakt](assets/image.png)

## Datasets

***Please follow the policy of each dataset and send application form to the official to request data. The data in our project are only used for scientific research.***
